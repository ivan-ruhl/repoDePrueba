...
const char final_countdown[] PROGMEM = "T125 V8 >b16 >a16 >b4 >e4 r4 r8 >>c16 >b16 >>c8 >b8 >a4 r4 r8 >>c16 >b16 >>c4 >e4 r4r8 >a16 >g16 >a8 >g8 >f+8 >a8 >g4 >f+16 >g16 >a4 >g16 >a16 >b8 >a8 >g8 >f+8 >e4 >>c4 >b2 >b16 >>c16 >b16 >a16 b1  ";
...
void setup()
{
  ...
  OrangutanBuzzer::playFromProgramSpace(final_countdown);
